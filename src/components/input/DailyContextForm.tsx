    ...
    <form onSubmit={handleSubmit(onNext)} className="space-y-10">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="space-y-4">
          ...
          <p className="text-xs text-slate-400 font-medium">{t('settingHint')}</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-slate-400 font-medium">{t('formalityHint')}</p>
        </div>
      </div>
      ...
      <div className="bg-green-50/50 rounded-[2.5rem] p-10 border border-green-100 flex items-start gap-6">
        ...
        <div>
          <h4 className="text-lg font-bold text-slate-900 mb-2">{t('tipTitle')}</h4>
          <p className="text-slate-600 font-medium leading-relaxed">{t('tipBody')}</p>
        </div>
      </div>

      <div className="flex flex-col md:flex-row items-center justify-between pt-10 border-t border-slate-100 gap-8">
        <div className="text-sm font-bold text-slate-400">{t('tipSkipHint')}</div>
