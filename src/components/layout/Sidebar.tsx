...
const NAV_ITEMS = [
  ...
  { name: 'Review', href: '/review', icon: CheckCircle2, badge: 35 },
  { name: 'Flashcards', href: '/flashcard/review', icon: Layers },
];
    ...
    <aside className="w-64 bg-white border-r border-slate-200 flex flex-col h-screen sticky top-0 shrink-0">
      ...
      <div className="p-4 space-y-1">
        ...
        >
          ...
          <span className="text-[15px] font-semibold">Help & Support</span>
        </Link>
